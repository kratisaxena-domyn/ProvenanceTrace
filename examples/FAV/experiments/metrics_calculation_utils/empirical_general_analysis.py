...
class GeneralAnalysis:
    ...
    def calculate_system_performance_metrics(self):
        ...
        for result in self.results:
            ...
            for component in ["agent_runtime", "trace_runtime", "entity_runtime", 
                            "retrieval_runtime", "fact_runtime", "halluc_runtime"]:
                if component in perf:
                    component_runtimes[component].append(perf[component])
            
            # Collect success rates
            for component in ["agent_success", "fact_success", "halluc_success", 
                            "trace_success", "entity_success", "retrieval_success"]:
                if component in perf:
